...
export interface TASKNFTInterface extends utils.Interface {
  ...
  functions: {
    ...
    "checkTotalMined()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "checkTotalMined",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface TASKNFT extends BaseContract {
  ...
  functions: {
    ...
    checkTotalMined(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    checkTotalMined(overrides?: CallOverrides): Promise<PopulatedTransaction>;
